...
future-work:
  In a future post, we will explore how the empirical error contributions can be determined based on data from large databases like EarthChem.
  We will additionally explore the confounding role of correlated errors and how best to account for their impacts and sidestep their negative influences.
key-points:
